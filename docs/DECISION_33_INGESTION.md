# Decision 33 ingestion gate

Freeze date: **2026-08-02**.

The final Decision 33/2026/QĐ-TTg was issued on 2026-06-30 and takes effect on
2026-08-15. It contains 46 listed AI-system use cases across six sectors. This is
not a drop-in replacement for the draft four-group catalog used by the frozen
hackathon manuscript.

## Why the legacy context is insufficient

The final rows depend on facts absent from the legacy eight-dimensional context,
including exact use case, degree of automation, whether an independent human
review exists, whether the system directly changes a physical state, biometric
or sensitive-attribute use, sector-specific value or scale thresholds, and when
the system was placed into operation.
